...
Related notes: [fragment-injection-simulation](fragment-injection-simulation.md), [heartbeat-fragment-flow](heartbeat-fragment-flow.md), [ripple-propagation-flow](.md) [index](../../unique/index.md)
