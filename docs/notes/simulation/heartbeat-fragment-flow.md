...
Related notes: [fragment-injection-simulation](fragment-injection-simulation.md), [heartbeat-fragment-flow](.md), [ripple-propagation-flow](ripple-propagation-flow.md) [index](../../unique/index.md)
