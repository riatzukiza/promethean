...
encoder_model = ie.read_model("../whisper-npu/models/whisper_medium/whisper_medium_encoder.xml")
...
cross_kv_model = ie.read_model("../whisper-npu/models/whisper_medium/whisper_medium_encoder_decoder_cross_kv.xml")
...
decoder_model = ie.read_model("../whisper-npu/models/whisper_medium/whisper_medium_decoder_static_kvcache_224_lm_QKs.xml")
